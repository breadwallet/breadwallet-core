...
static void testTransactionDeserialize1(const char* test_input)
{
    ...
    // Get the source, target, public key
    BRRippleAddress source = rippleTransactionGetSource(transaction);
    BRRippleAddress target = rippleTransactionGetSource(transaction);
    BRKey key = rippleTransactionGetPublicKey(transaction);
    // Just make sure that we got some target address
    uint8_t null_bytes[20] = {0};
    assert(0 != memcmp(target.bytes, null_bytes, 20));
...
const char * tx_three = "";
...
void rippleTransactionTests()
{
    ...
    testTransactionDeserialize1(tx_three);
}
