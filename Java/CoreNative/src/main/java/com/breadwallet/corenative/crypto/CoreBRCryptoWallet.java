...
public interface CoreBRCryptoWallet {
    ...
    void estimateFeeBasis(CoreBRCryptoAddress target, CoreBRCryptoAmount amount, CoreBRCryptoNetworkFee fee, Pointer context, BRCryptoWalletEstimateFeeBasisCallback callback);
