...
public interface CryptoLibrary extends Library {
    ...
    BRCryptoFeeBasis cryptoWalletEstimateFeeBasis(BRCryptoWallet wallet, BRCryptoAddress target, BRCryptoAmount amount, BRCryptoNetworkFee fee, Pointer context, BRCryptoWalletEstimateFeeBasisCallback callback);
    ...
    void cwmAnnounceGetGasEstimateSuccess(BRCryptoWalletManager cwm, BRCryptoCWMClientCallbackState callbackState, String gasEstimate);
